    ...
    <>
      ...
      <div className="mr-10 ml-10 text-center space-y-4">
        ...
        <div className="bg-white rounded-xl shadow-sm  p-4 md:p-8 max-w-md md:max-w-lg mx-auto border">
          ...
          <p className="text-sm text-gray-500">Nada de dieta genérica, tudo adaptado ao estilo de vida da pessoa.</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm  p-4 md:p-8 max-w-md md:max-w-lg mx-auto border">
          ...
          <p className="text-sm text-gray-500">Mais energia, sono regulado, intestino funcionando bem.</p>
        </div>
      </div>
